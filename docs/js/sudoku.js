...
function create16x16Puzzle(
    ...
    for (const position of positions) {
        ...
        const solutions =
            countSolutions16x16(testBoard);

        if (solutions === 1) {
            removed++;
        } else {
            // Removing this cell created
            // multiple/no solutions
...
// ==========================================
// FAST 16x16 SOLUTION COUNTER
// ==========================================

function countSolutions16x16(board, limit = 2) {
    ...
    function solve() {
        ...
        // Find the empty cell with the
        // fewest possible values (MRV)
        for (let row = 0; row < size; row++) {
        ...
        const box =
            Math.floor(bestRow / 4) * 4 +
            Math.floor(bestCol / 4);
